...
(function (global, factory) {
  ...
  */
  ...
  function orderModifiers(modifiers) {
    // case based on dependencies
    var orderedModifiers = order(modifiers); // case based on phase
  ...
  function popperGenerator(generatorOptions) {
    ...
    return function createPopper(reference, popper, options) {
      ...
      // update cycle runs. They will be executed in the same case as the update
